...
public class MatrixCellsInDistanceOrder {
    public static void main(String[] args) {
        ...
        Arrays.stream(result).forEach(array -> System.out.print(Arrays.toString(array)));
    }
    ...
    public static int[][] allCellsDistOrder(int R, int C, int r0, int c0) {
        ...
        Arrays.parallelSort(result, Comparator.comparingInt(a -> (Math.abs(r0 - a[0]) + Math.abs(c0 - a[1]))));
