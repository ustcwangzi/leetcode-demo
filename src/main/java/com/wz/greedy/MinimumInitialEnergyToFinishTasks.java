...
public class MinimumInitialEnergyToFinishTasks {
    ...
    /**
     * 贪心，按照 (minimum - actual) 对 tasks[][] 进行排序，然后遍历所有 task
     * 所需要的 energy 为 max{energy + minimum, actual}
     */
    public static int minimumEffort(int[][] tasks) {
        Arrays.parallelSort(tasks, Comparator.comparingInt(o -> o[1] - o[0]));
